...
type AddUltimatePotentialCardProps = {
  onAddClick: () => void;
};

export default function AddUltimatePotentialCard({ onAddClick }: AddUltimatePotentialCardProps) {
  return (
    <div 
      onClick={onAddClick}
      className="bg-white border-2 border-dashed border-gray-300 rounded-2xl p-4 hover:border-gray-400 hover:bg-gray-50 transition-all duration-200 cursor-pointer group h-50 flex flex-col"
    >
