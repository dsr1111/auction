...
type UltimatePotentialBuyCardProps = {
  item: UltimatePotentialBuyItem;
  onEditClick: (item: UltimatePotentialBuyItem) => void;
};

export default function UltimatePotentialBuyCard({ item, onEditClick }: UltimatePotentialBuyCardProps) {
